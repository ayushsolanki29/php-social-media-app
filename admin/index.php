...
<head>
  ...
  <title>Secret Space | Dashboard</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
      <img src="../assets/favicon/safari-pinned-tab.svg" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
      <span class="brand-text font-weight-light">Secret Space</span>
    </a>
   ...
   <tr>
                    ...
                    <td>
                      <div class="d-flex">
                        ...
                        <div>
                          <h5><?=$user['f_name'].' '.$user['l_name']?> - <span class="text-muted">@<?=$user['username']?></span></h5>
                    ...
                    <?php if($user['ac_status']==0): ?><button class="m-1 btn btn-warning btn-sm verify_user_btn" data-user-id="<?=$user['id']?>">Verify</button><?php endif; ?>
                        ...
                        <button style="display:<?=$user['blue_tick']==0?'':'none'?>" class="m-1 btn btn-primary btn-sm bluetick_btn" data-user-id="<?=$user['id']?>">Grant Bluetick</button>
                        <button style="display:<?=$user['blue_tick']==1?'':'none'?>" class="m-1 btn btn-warning btn-sm revoke_bluetick_btn" data-user-id="<?=$user['id']?>">Revoke Bluetick</button>
                        <button  class="m-1 btn btn-danger btn-sm delete_user ub" data-user-id="<?=$user['id']?>">Delete User</button>
...
?>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2024 <a href="#" target="_blank">Secret Space Pvt Ltd.</a>.</strong>
    All rights reserved.
